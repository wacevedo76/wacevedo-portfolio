...
var dayModeEle = document.getElementById('dayMode');
var nightModeEle = document.getElementById('nightMode');

function dayNightModeSwitcher(modeChoice) {
  var pageStyles = window.getComputedStyle(document.body);
  var style = document.documentElement.style; // style.setProperty('--seen-primary', 'black');
...
dayModeEle.addEventListener('click', function () {
  dayNightModeSwitcher('day');
});
nightModeEle.addEventListener('click', function () {
...
/******/ });
//# sourceMappingURL=page-5c8d0920f10f30ffe3f1.js.map